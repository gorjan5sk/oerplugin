...
if (isset($_POST['submit_login'])) { //Form has been submitted.
    ...
    if($result) {
      ...
      if($hasher->CheckPassword($password, $r->password)){
        ...
        $message = __('Корисничкото име или лозинка не се точни.<br />
            Осигурајте се дека копчето Caps Lock е исклучено и пробајте повторно.', 'oerplugin');
      }
    }
    else {
        $message = __('Корисничкото име или лозинка не се точни!<br />
    ...
    <div id="content">
        ...
        <div id="wrapper" style="width: 100%;">
            ...
            <div id="holder" style=" width: 360px; margin-left: auto; margin-right: auto;">
                ...
                <br /> 
                <a href="<?php echo $emailresetpassword_url  ?>"><?php _e('Ја заборавивте лозинката?','oerplugin') ?></a>
            </div> <!-- end-holder -->    
