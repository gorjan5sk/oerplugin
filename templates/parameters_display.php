...
function parameters_display() {
    ...
    if( isset($_GET['keyword']) ){
      $output .= "<input type='text' name = 'keyword' placeholder='" . __('Пребарување низ ресурсите"','oerplugin') . "' value='{$_GET['keyword']}' style='width: 195px' />";
    } else {
      $output .= "<input type='text' name = 'keyword' placeholder='" . __('Пребарување низ ресурсите','oerplugin') . "' style='width: 195px' />";
    }
    $output .= "<br />";
    $output .= "<input type='submit' value='". __('Пребарај','oerplugin') . "'";
    $output .= "<br />";
    $output .= "<br />";
