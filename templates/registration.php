...
if (isset($_POST['submit_register'])) {
    ...
    if( isset($reg_full_name) && $reg_full_name != ''
        ...
        //send activation email to user
	      $to = $reg_email;
	      $subject = __('Потврда за регистрација на oor.mk', 'oerplugin');
	      ...
	      $mail_message .= "\r\n";
	      $mail_message .= __('Активацискиот код ќе биде достапен една недела.', 'oerplugin');
	      $mail_message .= "\r\n";
	      $mail_message .= "\r\n";
	       
	      if(!wp_mail($to, $subject, $mail_message)) {
		      $fail_message = __('Не може да се прати имејлот за активација.', 'oerplugin');
	      }
	      else {
	      
		  $message = __('Регистрацијата е успешна. Треба да добиете имејл со линк преку кој ќе ја потврдите вашата регистрација.', 'oerplugin');
	      }
	    } //end-inner-inner-if
    ...
    if( ! is_email($reg_email))
      $fail_message = __('Имејл адресата што ја внесовте содржи невалидни карактери.', 'oerplugin');
      ...
      $fail_message = __('Веќе постои корисник регистриран со таа имејл адреса.', 'oerplugin');
    else
            ...
            <div id="register" style="background: #f5f5f5; width: 70%; padding: 20px; margin-left: auto; margin-right: auto;">
                ...
                <div id="holder" style=" width: 360px; margin-left: auto; margin-right: auto;">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            <?php _e('Потврди ја лозинката:', 'oerplugin'); ?>
                            <span style="color: red;">*</span>
                            <br />
                        ...
                        <div>
                            <?php _e('Линк до личен веб сајт или блог:', 'oerplugin'); ?><br />
                        ...
                        <br />
                        <br />
                        <input type="submit" name="submit_register" value="<?php _e('Регистрирај се', 'oerplugin'); ?>" />
