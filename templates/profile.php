...
<div id="primary">
    <div id="content">
        ...
        <div id="wrapper" style="width: 100%;">
            ...
            <div id="register" style="background: #f5f5f5; width: 500px; padding: 20px; margin-left: auto; margin-right: auto;">
            
            <div id="holder" style=" width: 500px; margin-left: auto; margin-right: auto;">
            
                <span style="font-size: 1.3em;">
                    <?php printf(__('Ажурирање на личен профил', 'oerplugin'), $reg_username); ?>
                    <br />
                    <strong><?php echo $reg_username; ?></strong>
                </span>
                <br />
                <br />
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <br />
                    <br />
                    <input type="submit" name="submit_edit" value="<?php _e('Ажурирај', 'oerplugin'); ?>" />
